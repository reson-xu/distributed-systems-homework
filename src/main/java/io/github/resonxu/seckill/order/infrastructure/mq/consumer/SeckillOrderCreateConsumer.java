...
import io.github.resonxu.seckill.order.application.SeckillOrderCreateAppService;
...
public class SeckillOrderCreateConsumer implements RocketMQListener<SeckillOrderCreateMessage> {
    ...
    private final SeckillOrderCreateAppService seckillOrderCreateAppService;
